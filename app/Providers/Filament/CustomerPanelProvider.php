 ...
 * belong to any team (e.g. customers created during event/training registration).
 * Identical configuration to {@see AdminPanelProvider} minus `->tenant()`, so
 * every route is reachable without a `{tenant}` segment. Data visibility here is
 * governed entirely by policies and per-resource query scoping, not by tenancy.
 */
