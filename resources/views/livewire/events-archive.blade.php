    ...
    @else
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            @foreach($events as $event)
                <a href="{{ route('event.show', $event) }}" wire:navigate class="rounded-2xl bg-[#111111] overflow-hidden flex flex-col group hover:ring-1 hover:ring-[#333333] transition-all">
