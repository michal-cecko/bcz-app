<section class="py-20">
 ...
 {{-- Icon --}}
 @if(! empty($icon))
 <div class="w-20 h-20 bg-bcz-red flex items-center justify-center text-white">
 <x-filament::icon :icon="$icon"class="w-10 h-10"/>
 </div>
 @elseif(! empty($icon_text))
 <div class="w-20 h-20 bg-bcz-red flex items-center justify-center font-display font-bold text-[28px] text-white">{{ brick_trans($icon_text) }}</div>
 @endif
 ...
 <a href="{{ $primaryHref }}"class="bg-bcz-red px-8 py-4 font-semibold text-white">{{ brick_trans($primary_button_text) }}</a>
 @endif
 ...
 <a href="{{ $secondaryHref }}"class="bg-[#111111] border border-[#333333] px-8 py-4 font-semibold text-white">{{ brick_trans($secondary_button_text) }}</a>
 @endif
 </div>
 @endif
 </div>
