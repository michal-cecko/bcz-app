...
<section class="px-8 pb-20 text-center"style="background-color: {{ $background_color ?? '#0A0A0A' }};">
 ...
 <a href="{{ $secondaryHref }}"class="inline-flex items-center gap-2 bg-[#111111] border border-[#333333] text-white font-semibold text-[15px] px-8 py-4 hover:bg-[#1a1a1a] transition">
 {{ $secondaryText }}
 </a>
 @endif
 </div>
