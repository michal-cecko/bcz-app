            ...
            <div class="mb-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    @foreach($round->battles as $battle)
                        <div class="rounded-2xl bg-[#111111] border border-[#1A1A1A] p-5">
                            ...
                            <div class="flex flex-col gap-2">
                                {{-- Competitor A --}}
                                <div class="flex items-center gap-3 py-2 rounded-lg px-3 {{ $battle->winner_id === $battle->competitor_a_id ? 'bg-bcz-red/10 border border-bcz-red/20' : 'bg-[#0A0A0A]' }}">
                                ...
                                {{-- Competitor B --}}
                                <div class="flex items-center gap-3 py-2 rounded-lg px-3 {{ $battle->winner_id === $battle->competitor_b_id ? 'bg-bcz-red/10 border border-bcz-red/20' : 'bg-[#0A0A0A]' }}">
