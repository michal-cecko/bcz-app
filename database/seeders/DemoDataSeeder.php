    ...
    public function run(): void
    {
        ...
        EventOrganization::factory()->paid(25.00)->create([
            ...
            'registration_form_schema' => [
                ['name' => 'first_name', 'type' => 'first_name', 'label' => ['sk' => 'Meno', 'en' => 'First name', 'cs' => 'Jméno'], 'width' => 'half', 'required' => true, 'has_condition' => false],
                ['name' => 'last_name', 'type' => 'last_name', 'label' => ['sk' => 'Priezvisko', 'en' => 'Last name', 'cs' => 'Příjmení'], 'width' => 'half', 'required' => true, 'has_condition' => false],
                ['name' => 'email', 'type' => 'email', 'label' => ['sk' => 'E-mail', 'en' => 'E-mail', 'cs' => 'E-mail'], 'width' => 'half', 'required' => true, 'has_condition' => false],
                ['name' => 'phone', 'type' => 'phone', 'label' => ['sk' => 'Telefón', 'en' => 'Phone', 'cs' => 'Telefon'], 'width' => 'half', 'required' => true, 'has_condition' => false],
                ['name' => 'birth_date', 'type' => 'birth_date', 'label' => ['sk' => 'Dátum narodenia', 'en' => 'Date of birth', 'cs' => 'Datum narození'], 'width' => 'half', 'required' => true, 'has_condition' => false],
                ['name' => 'gender', 'type' => 'gender', 'label' => ['sk' => 'Pohlavie', 'en' => 'Gender', 'cs' => 'Pohlaví'], 'width' => 'half', 'required' => true, 'has_condition' => false],
                ['name' => 'club', 'type' => 'text_input', 'label' => ['sk' => 'Klub / Tím', 'en' => 'Club / Team', 'cs' => 'Klub / Tým'], 'width' => 'half', 'required' => false, 'has_condition' => false],
                ['name' => 'weight', 'type' => 'number_input', 'label' => ['sk' => 'Váha (kg)', 'en' => 'Weight (kg)', 'cs' => 'Váha (kg)'], 'width' => 'half', 'required' => false, 'has_condition' => false],
                ['name' => 'experience', 'type' => 'select', 'label' => ['sk' => 'Úroveň skúseností', 'en' => 'Experience level', 'cs' => 'Úroveň zkušeností'], 'width' => 'half', 'required' => true, 'has_condition' => false, 'options' => "Začiatočník\nMierne pokročilý\nPokročilý\nProfesionál"],
                ['name' => 'notes', 'type' => 'textarea', 'label' => ['sk' => 'Poznámka', 'en' => 'Note', 'cs' => 'Poznámka'], 'width' => 'full', 'required' => false, 'has_condition' => false],
            ],
        ]);
