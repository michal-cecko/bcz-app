...
class PageSeeder extends Seeder
{
    ...
    private static function supportContent(): array
    {
        return [
            ...
            self::brick('stats', [
                'items' => [
                    ['number' => '100%', 'label' => ['sk' => 'Využité na rozvoj']],
                    ['number' => '0%', 'label' => ['sk' => 'Administratívne náklady']],
                    ['number' => '3+', 'label' => ['sk' => 'Roky transparentnosti']],
                ],
            ]),
            self::brick('cta', [
                'title' => ['sk' => 'Každý dar má zmysel'],
                'description' => ['sk' => 'Aj malá suma pomáha. Ďakujeme, že ste súčasťou našej komunity.'],
                'button_text' => ['sk' => '2% z dane'],
                'button_link_type' => 'page',
                'button_link_model_id' => self::pageId('tax_donation'),
                'background_color' => '#dc2626',
            ]),
        ];
    }
